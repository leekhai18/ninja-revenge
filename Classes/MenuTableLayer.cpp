...
void MainMenuScene::createTable()
{
	...
	bambooBottom->setPosition(visibleSize.width / 2, visibleSize.height / 2);
	//bambooBottom->setScale(visibleSize.width / bambooBottom->getContentSize().width);

	this->bambooTop = Sprite::create(BAMBOO_TOP_PATH);
	bambooTop->setPosition(visibleSize.width / 2, visibleSize.height / 2);
	//bambooTop->setScale(visibleSize.width / bambooTop->getContentSize().width);

	this->tableContent = Sprite::create(TABLE_CONTENT_PATH);
	tableContent->setPosition(visibleSize.width / 2, visibleSize.height / 2);
	//tableContent->setScale(visibleSize.width / tableContent->getContentSize().width);

	this->tableHeader = Sprite::create(TABLE_HEADER_PATH);
	tableHeader->setPosition(visibleSize.width / 2, visibleSize.height - tableHeader->getContentSize().height/2);
	//tableHeader->setScale(visibleSize.width / tableHeader->getContentSize().width);
...
{
	//bambooBottom->removeFromParent();
	//bambooTop->removeFromParent();
	//tableContent->removeFromParent();
	//tableHeader->removeFromParent();

	this->addChild(bambooBottom);
	this->addChild(bambooTop);
	this->addChild(tableContent);
